/**
 * @aima/core — CognitiveWorkspace Public Interface
 *
 * This file defines the TypeScript contracts for CognitiveWorkspace.
 * These are the authoritative interface definitions for Feature 001.
 * Implementation lives in src/workspace/index.ts.
 */
