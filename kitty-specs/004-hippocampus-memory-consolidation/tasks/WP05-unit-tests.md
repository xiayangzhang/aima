...
- 2026-03-11T03:17:32Z – claude – shell_pid=70094 – lane=done – Post-review additions: (1) discovered searchMemory was not filtering forgotten=true via real integration tests; (2) fixed by introducing activeMemory() helper consolidating both soft-delete mechanisms (tInvalid + forgotten) into one canonical definition; (3) added hippocampus-methods.test.ts covering all 6 new CognitiveWorkspace methods with real DB. All changes committed to WP05 branch and included in this merge.
